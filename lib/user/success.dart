      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Text("       Your booking is successfully completed",style: GoogleFonts.inknutAntiqua(color:Colors.white,fontSize:18),),
          ),
          Padding(
            padding: const EdgeInsets.only(top: 80),
            child: ElevatedButton(style: ButtonStyle(shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(7),side: BorderSide(color: Colors.white))),backgroundColor: MaterialStatePropertyAll(Colors.green)),onPressed: (){}, child: Text("Done",style: GoogleFonts.inknutAntiqua(color:Colors.white,fontSize:18),)),
          )
        ],),
