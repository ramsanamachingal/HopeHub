                          ...
                          Padding(
                            ...
                            child: Column(
                             mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text(
                                    "Trust that your stories are safe and secure with us",style: GoogleFonts.inriaSans(color:Colors.white,fontSize:20,shadows:[Shadow(color: Colors.black,blurRadius: 7,)])),
                              ],
                            ),
                          ),
                              Padding(padding: EdgeInsets.only(bottom:20)),
                              ElevatedButton(style:  ButtonStyle( shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius:BorderRadius.circular(12),side:BorderSide(color: Colors.white))),backgroundColor:MaterialStatePropertyAll(Color.fromARGB(255, 240, 165, 67))),
                                onPressed: (){
                                ...
                                child: Row(
                                  children: [
                                    Center(child: Padding(
                                      ...
                                      child: Text("Already have an account?",style: GoogleFonts.inknutAntiqua(color:Colors.white,shadows:[Shadow(color: Colors.black,blurRadius: 7,)]),),
                                    )),
                                    TextButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>loginpage()));}, child:  Text("Login",style: GoogleFonts.inknutAntiqua(color:Colors.amber[800],),
                                ))
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(top: 600),
                            child: Text(
                                "You're not alone. I'm here for you, always.",style: GoogleFonts.inriaSans(color:Colors.white,fontSize:20,shadows:[Shadow(color: Colors.black,blurRadius: 7)])),
                          ),
                              Padding(padding: EdgeInsets.only(bottom:20)),
                              ElevatedButton(style:  ButtonStyle( shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius:BorderRadius.circular(12),side:BorderSide(color: Colors.white))),backgroundColor:MaterialStatePropertyAll(Color.fromARGB(255, 240, 165, 67))),
                                onPressed: (){
                              ...
                              Center(
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Already have an account?",style: GoogleFonts.inknutAntiqua(color:Colors.white,shadows:[Shadow(color: Colors.black,blurRadius: 7,)]),),
                                     TextButton(onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>loginpage()));}, child:  Text("Login",style: GoogleFonts.inknutAntiqua(color:Colors.amber[800],),
                                  ))
                                    ],
                                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                                "Instantly chat with experts any time of the day ",style: GoogleFonts.inriaSans(color:Colors.white,fontSize:20,shadows:[Shadow(color: Colors.black,blurRadius: 7,),])),
                          ),
                              Padding(padding: EdgeInsets.only(bottom:20)),
                              ElevatedButton(style:  ButtonStyle( shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius:BorderRadius.circular(12),side:BorderSide(color: Colors.white))),backgroundColor:MaterialStatePropertyAll(Color.fromARGB(255, 240, 165, 67))),
                                onPressed: (){
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(top: 600,left: 20),
                            child: Text(
                                "You are stronger than you know, braver than you feel",style: GoogleFonts.inriaSans(color:Colors.white,fontSize:20,shadows:[Shadow(color: Colors.black,blurRadius: 7,)])),
                          ),
                              Padding(padding: EdgeInsets.only(bottom:20)),
                              ElevatedButton(style:  ButtonStyle( shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius:BorderRadius.circular(12),side:BorderSide(color: Colors.white))),backgroundColor:MaterialStatePropertyAll(Color.fromARGB(255, 240, 165, 67))),
                                onPressed: (){
