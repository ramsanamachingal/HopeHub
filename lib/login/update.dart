        ...
        child: Center(
          ...
          padding: const EdgeInsets.only(bottom: 50),
            child: Container(
              ...
              decoration:BoxDecoration(color: Colors.white70,borderRadius: BorderRadius.circular(7)),
              child:Padding(
                padding: const EdgeInsets.only(top: 50,left: 10),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [Text("Password Changed",style: GoogleFonts.inknutAntiqua(color:Colors.amber[900],
                  fontSize:20,shadows:[Shadow(color: Colors.black)]),),Padding(
                    padding: const EdgeInsets.only(top: 20),
                    child: Text("You’re successfully changed password",style: GoogleFonts.inknutAntiqua(
                      color:Colors.black,fontSize:15),),
                  ),
                    Padding(
                      padding: const EdgeInsets.only(top: 30),
                      child: Icon(Icons.verified,color: Colors.amber[900],size: 70,),
                    ),
